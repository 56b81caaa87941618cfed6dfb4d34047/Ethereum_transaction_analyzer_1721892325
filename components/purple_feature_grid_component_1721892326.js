...
Vue.component("purple_feature_grid_component_1721892326", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our cutting-edge transaction monitoring system. Get instant alerts for new Ethereum transactions as they occur, allowing you to react swiftly to market changes.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our powerful analytics engine dissects every transaction, providing you with comprehensive insights into transaction details, value transfers, and smart contract interactions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Customize your transaction feed with advanced filtering and sorting options. Quickly identify transactions of interest based on value, address, or specific criteria.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Navigate through the transaction data with ease, thanks to our intuitive and user-friendly interface. Quickly access the information you need without getting lost in complexity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">Integration with Popular Tools</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Seamlessly integrate our transaction monitoring capabilities with your existing tools and workflows. Leverage APIs and plugins for a seamless experience.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Trust our platform to handle your transaction data with the utmost security and reliability. We employ industry-leading security practices to safeguard your information.</p></div>
        </div>
    </div>`,
        data() {
            return {
